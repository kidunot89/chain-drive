...
import { every, omit, reduce, each } from 'lodash';
...
function (_React$PureComponent) {
  ...
  _createClass(Chain, [{
    ...
    value: function timeout() {
      return reduce(this.state.animations, function (result, _ref) {
    ...
    value: function isReady() {
      ...
      if (this.state.in) {
        ...
        switch (this.state.order.substring(0, 2)) {
          case 'li':
            ready = every(this.state.innerChains, function (state) {
    ...
    value: function render() {
      ...
      var transProps = omit(this.props, ['id', 'children', 'updateParent', 'parentState', 'parentOrder', 'order', 'in']);
...
var calculate = function calculate(rootEl, params) {
  ...
  if (typeof delay === 'function') {
    ...
    if (Array.isArray(targets)) {
      return duration + reduce(targets, function (highestDelay, nextTarget, index, list) {
...
var processTimeout = function processTimeout(rootEl, params) {
  if (params) {
    if (Array.isArray(params)) {
      return reduce(params, function (total, nextParams) {
  ...
  function (_React$PureComponent) {
    ...
    _createClass(AnimeJs, [{
      ...
      value: function animateTimeline(state) {
        ...
        var rootEl = this.ref.current;
        each(this.props[state], function (params) {
      ...
      key: "render",
      value: function render() {
        var props = omit(this.props, ['entering', 'entered', 'exiting', 'exited', 'processTimeout']);
        return React.createElement(BaseComponent, Object.assign({
          ref: this.ref,
...
export { withAnime as withAnimeJs, chainInitialState, ChainContext, chainedConsumer, Chain, InnerChain };
